...
//				'げ', 'さ', 'ご'};
	...
	public static Result writeKorean(String str, int cursorPos, int selecPos, char c) {
		System.out.println("{str: " + str + ", cursorPos: " + cursorPos + ", selecPos: " + selecPos + ", c: " + c);// XXX Test
		
		StringBuilder sb = new StringBuilder(str);
		cursorPos = Math.min(cursorPos, sb.length());
		selecPos = Math.min(selecPos, sb.length());
